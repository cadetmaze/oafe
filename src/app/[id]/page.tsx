  ...
  return (
    <div className="grid h-dvh grid-rows-[64px_minmax(0,1fr)] overflow-hidden bg-white">
      ...
      <main
        ...
        className="grid min-h-0 grid-cols-[minmax(0,1fr)_minmax(0,2fr)]"
        data-request-id={id}
      >
        <section
          aria-labelledby="prompt-chat-heading"
          className="flex min-h-0 min-w-0 flex-col border-r border-[#E1E1E1] bg-white"
        >
        ...
        <section
          ...
          className="min-h-0 min-w-0 bg-[#FAFAFA]"
        >
